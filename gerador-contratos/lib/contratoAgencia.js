...
function buildAgenciaContract(data) {
  ...
  c.add("DIREITOS AUTORAIS, USO DOS MATERIAIS, PORTFÓLIO E IMAGEM DE TERCEIROS", [
    "Após a quitação integral dos valores devidos, os direitos patrimoniais de uso dos materiais finais produzidos no âmbito deste contrato serão cedidos à CONTRATANTE, para utilização em seus canais digitais, campanhas, apresentações e materiais institucionais.",
    ...
    "Materiais brutos, arquivos editáveis, projetos abertos e arquivos-fonte somente serão entregues se houver previsão expressa em proposta comercial ou ajuste específico por escrito.",
    "A responsabilidade pela obtenção da autorização de uso de imagem e voz de pessoas físicas que figurem nos materiais audiovisuais (atores, modelos, apresentadores, colaboradores ou representantes) será definida por projeto, conforme indicação expressa entre as partes no briefing correspondente. Na ausência de indicação expressa: (i) caberá à CONTRATANTE obter a autorização de colaboradores, sócios, representantes ou terceiros por ela indicados; (ii) caberá à CONTRATADA obter a autorização de talentos, modelos ou atores por ela diretamente contratados para a produção."
  ]);

  c.add("CONFIDENCIALIDADE", [
    "As partes obrigam-se a manter absoluto sigilo sobre todas as informações, dados, estratégias, materiais internos, bastidores, processos, campanhas, acessos, documentos, planejamentos e quaisquer informações não públicas a que tiverem acesso em razão deste contrato.",
    "A obrigação de sigilo permanecerá válida durante a vigência contratual e pelo prazo de 5 (cinco) anos após seu término, independentemente do motivo de encerramento.",
    "O descumprimento desta cláusula sujeitará a parte infratora à apuração de perdas e danos, sem prejuízo das medidas judiciais cabíveis."
  ]);

  c.add("PROTEÇÃO DE DADOS PESSOAIS (LGPD)", [
    "As partes se comprometem a tratar quaisquer dados pessoais a que tenham acesso em decorrência deste contrato em conformidade com a Lei nº 13.709/2018 (LGPD), utilizando-os exclusivamente para as finalidades relacionadas à execução dos serviços aqui previstos.",
    "Para os fins deste contrato, a CONTRATANTE figura como controladora dos dados pessoais de sua base de clientes, leads e colaboradores eventualmente compartilhados, e a CONTRATADA figura como operadora, devendo tratar tais dados estritamente conforme as instruções da CONTRATANTE e as finalidades pactuadas.",
    "Ao término do contrato, a CONTRATADA deverá, mediante solicitação da CONTRATANTE, eliminar ou devolver os dados pessoais tratados em razão deste contrato, salvo obrigação legal de retenção."
  ]);

  c.add("CASO FORTUITO E FORÇA MAIOR", [
    "Nenhuma das partes será responsabilizada por atraso ou não cumprimento de obrigações decorrentes de caso fortuito ou força maior, incluindo condições climáticas que impeçam captação externa previamente agendada, problemas de saúde da equipe envolvida na execução, falhas generalizadas de conectividade/infraestrutura, ou determinações governamentais supervenientes.",
    "A parte impedida deverá comunicar a outra por escrito, tão logo possível, informando a natureza do impedimento e a nova estimativa de prazo, sem que isso configure inadimplemento contratual."
  ]);

  // ---- Rescisão (regra de multa por faixa de tempo definida pela Fábrica) ----
  c.add("RESCISÃO E CANCELAMENTO", [
    "O presente contrato poderá ser rescindido por qualquer das partes, sem necessidade de justa causa, mediante aviso prévio por escrito com antecedência mínima de 30 (trinta) dias.",
    "Em caso de rescisão por descumprimento contratual (justa causa) por qualquer das partes, o contrato poderá ser encerrado imediatamente mediante notificação por escrito, apontando a infração cometida.",
    "Regra de cancelamento antecipado pela CONTRATANTE, aplicável exclusivamente aos casos de rescisão sem justa causa e observado o aviso prévio da cláusula anterior:",
    ...
    "Em caso de rescisão sem justa causa pela CONTRATADA durante a vigência, e observado o aviso prévio, a CONTRATADA deverá concluir as entregas já iniciadas e em andamento no mês vigente, sem custo adicional para a CONTRATANTE, ressalvados novos escopos ainda não iniciados."
  ]);

  c.add("INEXISTÊNCIA DE VÍNCULO", [
    "O presente contrato possui natureza estritamente comercial, não gerando vínculo trabalhista, societário, de representação, parceria, franquia ou exclusividade entre as partes, sendo cada uma responsável por seus funcionários, colaboradores, prestadores e encargos."
  ]);

  c.add("DISPOSIÇÕES GERAIS", [
    "Qualquer alteração de escopo, quantidade de entregas, prazo, valor ou obrigação deverá ser formalizada por escrito entre as partes.",
    "A eventual tolerância de uma parte quanto ao descumprimento de qualquer obrigação não constituirá novação, renúncia ou alteração contratual.",
    "As partes reconhecem a validade da assinatura eletrônica ou digital do presente instrumento, dispensando-se reconhecimento de firma, salvo se expressamente solicitado por uma das partes.",
    "Este instrumento representa o entendimento integral entre as partes quanto ao seu objeto, substituindo quaisquer entendimentos, propostas, e-mails ou tratativas verbais anteriores sobre a mesma matéria, ressalvados aditivos formalizados por escrito após sua assinatura.",
    "Se qualquer disposição deste contrato for considerada nula ou inexequível, as demais disposições permanecerão em pleno vigor e efeito."
  ]);

  c.add("RESOLUÇÃO DE CONFLITOS E FORO", [
    "As partes se comprometem a buscar, previamente a qualquer medida judicial, a resolução amigável de eventuais controvérsias decorrentes deste contrato, por meio de negociação direta ou mediação.",
    `Não havendo composição amigável no prazo de 15 (quinze) dias, fica eleito o foro da Comarca de ${FABRICA.cidade} para dirimir quaisquer controvérsias oriundas deste contrato, com renúncia expressa a qualquer outro, por mais privilegiado que seja.`
  ]);
