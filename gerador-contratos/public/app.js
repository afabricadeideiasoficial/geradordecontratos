...
function setTipo(tipo) {
  ...
  secaoAgencia.classList.toggle("hidden-section", tipo !== "agencia");
  secaoAvulso.classList.toggle("hidden-section", tipo !== "avulso");
}
...
form.addEventListener("submit", async (e) => {
  ...
  // normalize checkbox values (unchecked boxes don't appear in FormData)
